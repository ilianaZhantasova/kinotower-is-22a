...
<template>
  ...
  <div class="row" v-if="filmDetailStore.film">
    ...
    <div class="col d-flex flex-column align-items-center">
      <div class="mb-2"><a @click.prevent="addRating(5)" href="#" class="text-warning"><i class="fa-solid fa-star fa-2xl"></i></a></div>
      <div><a @click.prevent="addRating(4)" href="#" class="text-warning"><i class="fa-solid fa-star fa-xl"></i></a></div>
      <div><a @click.prevent="addRating(3)" href="#" class="text-warning"><i class="fa-solid fa-star fa-lg"></i></a></div>
      <div><a @click.prevent="addRating(2)" href="#" class="text-warning"><i class="fa-solid fa-star fa-sm"></i></a></div>
      <div><a @click.prevent="addRating(1)" href="#" class="text-warning"><i class="fa-solid fa-star fa-xs"></i></a></div>
    </div>
  </div>
  <div class="row">
  ...
  <div class="row">
    <div class="col-md-1">{{ filmDetailStore.film.duration }}</div>
    ...
    <div class="col-md-3">
    <template v-for="category in filmDetailStore.film.categories">
    {{category.name}},
    </template>
    </div>
    <div class="col-md-3 text-end"><a :href="filmDetailStore.film.link_kinopoisk" target="__blank">Kinopoisk</a></div>
  </div>
  <div class="row">
    <div class="col-md-10">
      <div class="mt-3">
  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-md-11">
        <div class= row 
        v-for="review in filmDetailStore.reviews" 
        :key="review.id">
          <div class="col">
            <div class="row">
